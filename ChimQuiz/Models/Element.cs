...
118;Og;Oganesson;294.0";
        ...
        private static readonly Dictionary<string, string> FunFacts = new(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["Sc"] = "Le scandium a été prédit par Mendeleïev en 1871 sous le nom 'd'ékaboron', et découvert en 1879 — exactement là où il l'avait prévu!",
            ["V"] = "Le vanadium tire son nom de 'Vanadis', déesse nordique de la beauté, en référence à ses superbes composés aux couleurs vives.",
            ["Rb"] = "Le rubidium s'enflamme spontanément à l'air et explose violemment au contact de l'eau, comme son voisin le sodium mais en bien plus spectaculaire!",
            ["Sr"] = "Le strontium donne la couleur rouge aux feux d'artifice. La ville écossaise de Strontian lui a donné son nom lors de sa découverte en 1790.",
            ["Y"] = "L'yttrium vient du village suédois d'Ytterby — cette même mine a donné son nom à 4 éléments : yttrium, ytterbium, erbium et terbium!",
            ["Zr"] = "Le zirconium est si résistant à la corrosion et à la chaleur qu'il enveloppe les barres de combustible dans les réacteurs nucléaires.",
            ["Nb"] = "Le niobium portait deux noms : 'colombium' aux USA et 'niobium' en Europe — ce désaccord dura plus d'un siècle avant qu'on choisisse niobium en 1950.",
            ["Mo"] = "Le molybdène fond à 2 623°C, soit la moitié de la température de surface du Soleil. Il est indispensable à la fixation biologique de l'azote.",
            ["Tc"] = "Le technétium est le premier élément chimique créé artificiellement par l'homme, en 1937 par bombardement de molybdène avec des deutérons.",
            ["Ru"] = "Le ruthénium a été nommé en hommage à la Russie (Ruthenia). C'est l'un des catalyseurs les plus efficaces connus pour la production d'hydrogène.",
            ["Rh"] = "Le rhodium est parfois le métal le plus cher du monde, dépassant 500 €/gramme — soit 15 fois plus cher que l'or!",
            ["Pd"] = "Le palladium peut absorber jusqu'à 900 fois son volume en hydrogène gazeux — une propriété unique utilisée pour purifier et stocker l'hydrogène.",
            ["Cd"] = "La maladie 'Itaï-Itaï' (mot japonais pour 'aïe aïe') au Japon dans les années 1950 fut causée par une contamination des rizières au cadmium industriel.",
            ["In"] = "L'indium émet un cri caractéristique (craquement sonore) quand on le plie, exactement comme l'étain. Il fond à 156°C, moins chaud qu'un four de cuisine.",
            ["Sb"] = "L'antimoine était utilisé comme fard à yeux noir (khôl) par les Égyptiens de l'Antiquité, il y a plus de 5 000 ans!",
            ["Te"] = "Le tellure est plus rare sur Terre que le platine ou l'or — mais il est très abondant sur les astéroïdes et dans les nébuleuses stellaires.",
            ["Pr"] = "Les lunettes de soudeur qui filtrent la lumière aveuglante contiennent du praséodyme. Son nom vient du grec 'prasios' (vert) + 'didymos' (jumeau).",
            ["Pm"] = "Le prométhium est le seul lanthanide sans isotope stable. Nommé d'après Prométhée, le titan qui vola le feu aux dieux — un élément 'volé' à la nature!",
            ["Sm"] = "Les aimants samarium-cobalt résistent à la démagnétisation jusqu'à 300°C — là où les aimants néodyme deviennent inefficaces. Idéaux pour les moteurs de missiles.",
            ["Tb"] = "Le terbium change physiquement de forme dans un champ magnétique (magnétostriction). Cette propriété est utilisée pour faire vibrer les coques de sous-marins en sonar.",
            ["Dy"] = "Le dysprosium tire son nom du grec 'dysprositos' qui signifie 'difficile d'accès' — et pour cause, il fallut des années pour l'isoler pur!",
            ["Ho"] = "L'holmium possède le moment magnétique le plus élevé de tous les éléments naturels. Son nom vient de 'Holmia', nom latin de Stockholm.",
            ["Er"] = "L'erbium amplifie les signaux lumineux dans les câbles à fibres optiques. Sans lui, Internet mondial à haut débit ne serait pas possible!",
            ["Tm"] = "Le thulium, nommé d'après 'Thule' (la Scandinavie mythique), est si rare qu'un seul gramme suffit pour fabriquer des milliers d'appareils radiologiques portables.",
            ["Yb"] = "Les horloges atomiques à l'ytterbium ne se déréglent pas d'une seconde en 40 milliards d'années — soit 3 fois l'âge actuel de l'Univers!",
            ["Lu"] = "Le lutécium tire son nom de 'Lutetia', le nom latin de Paris, en hommage à la ville où le chimiste Georges Urbain l'isola en 1907.",
            ["Hf"] = "Le hafnium (Hafnia = Copenhague en latin) fut prédit par Niels Bohr grâce à sa théorie des orbitales atomiques, puis découvert exactement là où il l'avait prévu.",
            ["Ta"] = "Le tantale est presque totalement insensible aux acides — il résiste à l'acide chlorhydrique, sulfurique et même à l'eau régale à froid!",
            ["Re"] = "Le rhénium a été le dernier élément naturel stable découvert (1925). Son nom vient du Rhin (Rhenus). Il possède le 3ème point de fusion le plus élevé de tous les éléments.",
            ["Tl"] = "Le thallium est si toxique et insidieux (incolore, inodore, soluble) qu'il a été utilisé dans de célèbres affaires d'empoisonnement et surnommé 'poison de l'héritage'.",
            ["Rn"] = "Le radon s'accumule dans les sous-sols mal ventilés de certaines régions granitiques. Il est la 2ème cause de cancer du poumon après le tabac en Europe.",
            ["Fr"] = "Le francium est l'élément naturel le plus rare et instable : il n'existe qu'environ 30 grammes dans toute la croûte terrestre à un instant donné!",
            ["Ac"] = "L'actinium émet une lueur bleue-verte dans le noir, causée par l'ionisation de l'air environnant par sa forte radioactivité.",
            ["Th"] = "Le thorium pourrait alimenter des réacteurs nucléaires pendant 10 000 ans avec les réserves mondiales connues — et produit bien moins de déchets à longue durée de vie.",
            ["Pa"] = "Le protactinium est l'un des éléments les plus coûteux à extraire : sa production à partir de minerais d'uranium coûte plusieurs millions d'euros par gramme.",
            ["Np"] = "Comme Uranus précède Neptune dans le système solaire, l'uranium précède le neptunium dans le tableau périodique — les actinides suivent l'ordre des planètes!",
            ["Cm"] = "Le curium a été nommé en hommage à Pierre et Marie Curie. Ironiquement, Marie Curie n'a jamais su qu'un élément porterait son nom — il fut découvert 2 ans après sa mort.",
            ["Bk"] = "Le berkélium, synthétisé en 1949, porte le nom de Berkeley (Californie). Il fut si difficile à produire qu'on attendit 9 ans avant d'en fabriquer assez pour le peser!",
            ["Cf"] = "Le californium est tellement radioactif qu'un microgramme émet 170 millions de neutrons par seconde. Il peut démarrer des réacteurs nucléaires sans électricité.",
            ["Es"] = "L'einsteinium fut découvert en secret dans les débris de la première bombe à hydrogène américaine 'Ivy Mike' en 1952, et l'annonce fut retardée pour des raisons militaires.",
            ["Fm"] = "Le fermium fut aussi découvert secrètement dans les retombées d'Ivy Mike. Einstein et Fermi, qui leur donnèrent leur nom, moururent tous deux en 1955 sans le savoir.",
            ["Md"] = "Le mendélévium fut synthétisé atome par atome en 1955 — littéralement un atome à la fois par cyclotron, ce qui prit des mois pour en produire quelques dizaines.",
            ["No"] = "Le nobélium fut d'abord annoncé par erreur par un laboratoire suédois. La véritable synthèse, par une équipe soviéto-américaine, prit des années à être reconnue.",
            ["Lr"] = "Le lawrencium clôt la série des actinides. Sa configuration électronique défie les règles du tableau périodique, un fait confirmé seulement en 2015!",
            ["Rf"] = "Le rutherfordium, premier élément super-lourd, a une demi-vie de seulement 65 secondes pour son isotope le plus stable. Nommé en hommage à Ernest Rutherford.",
            ["Db"] = "Le dubnium ne peut être créé qu'en accélérateur de particules. Sa synthèse fut l'objet d'une dispute de priorité entre USA et URSS pendant la Guerre froide.",
            ["Sg"] = "Le seaborgium fut le premier élément nommé du vivant de son découvreur : Glenn Seaborg put ainsi voir son nom dans le tableau périodique avant de mourir.",
            ["Bh"] = "Le bohrium a une demi-vie d'à peine 17 secondes. Ses propriétés chimiques confirment qu'il se comporte comme ses voisins plus légers du groupe 7 (manganèse, rhénium).",
            ["Hs"] = "Le hassium, nommé d'après l'État de Hesse (Allemagne), a été étudié chimiquement malgré sa demi-vie de quelques secondes — un exploit expérimental extraordinaire.",
            ["Mt"] = "Le meitnérium honore Lise Meitner, pionnière de la fission nucléaire, qui fut injustement ignorée pour le Nobel. C'est l'un des rares éléments nommés d'après une femme.",
            ["Ds"] = "Le darmstadtium a été synthétisé pour la première fois en 1994 à Darmstadt (Allemagne). Son isotope le plus stable disparaît en seulement 12 secondes.",
            ["Rg"] = "Le roentgenium honore Wilhelm Röntgen, découvreur des rayons X. Seuls quelques atomes ont jamais été produits, chacun vivant moins d'une minute.",
            ["Cn"] = "Le copernicium, nommé en hommage à Copernic, pourrait être liquide à température ambiante — le seul métal du tableau périodique avec cette particularité (avec le mercure).",
            ["Nh"] = "Le nihonium (Nihon = Japon en japonais) est le premier élément découvert en Asie. Il a fallu 9 ans d'expériences au RIKEN pour en synthétiser seulement 3 atomes!",
            ["Fl"] = "Le flérovium honore le physicien Flerov, qui nota en 1940 que l'uranium-235 pouvait fissionner spontanément — observation clé pour la bombe atomique.",
            ["Mc"] = "Le moscovium n'existe que l'espace d'un éclair : son isotope le plus stable disparaît en 220 millisecondes. Nommé en hommage à la région de Moscou.",
            ["Lv"] = "Le livermorium est si instable qu'on ne peut pas encore étudier sa chimie. Il porte le nom du Lawrence Livermore National Laboratory en Californie.",
            ["Ts"] = "Le tennessine honore l'État du Tennessee (USA), siège de plusieurs laboratoires nucléaires majeurs. Il n'a été synthétisé qu'en 2010.",
            ["Og"] = "L'oganesson est le dernier élément du tableau périodique actuel. C'est un gaz noble, mais les calculs prédisent qu'il serait solide à température ambiante — une anomalie totale!",
        };
